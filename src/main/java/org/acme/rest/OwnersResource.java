...
public class OwnersResource {
    ...
    @Transactional
    @Path("addOwner")
    public Response addOwner(OwnerForm ownerForm) {
    ...
    @Produces(MediaType.TEXT_HTML)
    @Path("getOwner")
    public TemplateInstance getOwner(@QueryParam("ownerId") Long ownerId) {
    ...
    @Transactional
    @Path("editOwner")
    public Response editOwner(OwnerForm ownerForm, @QueryParam("ownerId") Long ownerId) {
